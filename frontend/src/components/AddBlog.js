...
const AddBlog = () => {
  ...
  const sendRequest = async () => {
    console.log("Submitting blog with this data:", {
      title: inputs.title,
    ...
    try {
      ...
      console.log("Request successful, response:", res.data); // Added for success
      const data = res.data;
      setErrorMsg('');
      return data;
    } catch (error) {
      // This will now log the exact error to the browser console
